...
export const PROJECTS: Project[] = [
  ...
  { group:'Active', id:'trace', name:'Trace (Kultur) - MVP', status:'In Dev',
    ...
    personnel:[
      {name:'Niv Matityahu',role:'Developer',pct:5,hours:2,subStart:'2026-02-01',subEnd:'2026-03-31'},
    ]},
  ...
  { group:'Active', id:'vital', name:'Vital', status:'In Dev',
    ...
    required:{Developer:0,PM:0,Designer:0},
    personnel:[
      {name:'Hai Morgenstern',role:'Developer',pct:10,hours:4,subStart:'2026-03-10',subEnd:'2026-04-09'},
    ]},
